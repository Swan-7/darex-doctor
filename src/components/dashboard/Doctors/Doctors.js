  ...
  return (
    <div id="main">
      <div style={{ width: "100%" }}>
        <MaterialTable
          ...
          columns={[
            {
              title: "#",
              field: "data.docNumber",
            },
            { title: "First Name", field: "data.firstName" },
            {
              title: "Last Name",
              field: "data.lastName",
            },
          ...
          actions={[
            ...
            },
            {
              ...
              onClick: (event, rowData) => {
                setEdit(true);
                setResponse(true);
                setFirstName(rowData.data.firstName);
                setLastName(rowData.data.lastName);
                setEmailNew(rowData.data.email);
                setAuthorised(rowData.data.authorised);
                setSpecialty(rowData.data.specialty);
      ...
      {response && (
        ...
        >
          <h2>{edit ? "EDIT DOCTOR DETAILS" : "ADD DOCTOR"}</h2>
          <IconButton
            style={{
              position: "absolute",
              right: 10,
          ...
          <div>
            ...
            >
              ...
              <TextField
                ...
                rows={1}
                onChange={(value) => {
                  setSpecialty(value.target.value);
                }}
                value={specialty}
              />
            </div>
